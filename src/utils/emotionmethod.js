...
Vue.prototype.parsingEmoji = function(value) {
  ...
  str = str.replace(wChartReg, function(wCeo) {
    return (
      '<span class="chat-emoji emoji_b ' +
      wChatEmojis[_escapeToUtf32(wCeo).toLocaleUpperCase()] +
      '" data-name="' +
      wChatToUi[_escapeToUtf32(wCeo).toLocaleUpperCase()] +
      '"></span>'
    );
  });
  return str;
...
// Vue.prototype.parsingEmojiImg = function(value) {
//   if (!value) return "";
//   let str = value;
//   str = str.replace(/\n/gi, "<br>");
//   // str = EmojiUnicode.trans(str);
...
//     var s = s.split("[")[1].split("]")[0];
//     if (emojisAmap[s]) {
//       // let index = emojisAmap.indexOf(s)
//       console.log('返回值' + s + emojisAmap[s])
//       return (
//         `<img src="https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/${0}.gif" align="middle"></img>`
//         // '<span class="chat-emoji emoji_a ' +
//         // emojisAmap[s] +
//         // '" data-name="' +
//         // s +
